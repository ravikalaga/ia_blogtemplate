<ul id="isIa3Tabs">
    <li><strong><a href="?page=ia3&amp;tab=1"><?php _e('Navigation', 'ia3'); ?></a></strong></li>
                ...
                <tr>
                    <th>
                        <div style="margin-right:38px">
                            <input class="isInputText" name="I-Header-1-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Header-1-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                    <th>
                        <div style="margin-right:38px">
                            <input class="isInputText" name="I-Header-2-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Header-2-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                    <th>
                        <div style="margin-right:38px">
                            <input class="isInputText" name="I-Header-3-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Header-3-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                    <th>
                        <div style="margin-right:38px;">
                            <input class="isInputText" name="I-Header-4-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Header-4-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                </tr>
                <tr>
        ...
        <div class="isIa3Nav">
            ...
            <table class="isIa3NavTable">
                <tr>
                    <th>
                        <div style="margin-right:38px">
                            <input class="isInputText" name="I-Contact-1-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Contact-1-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                    <th>
                        <div style="margin-right:38px">
                            <input class="isInputText" name="I-Contact-2-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Contact-2-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                    <th>
                        <div style="margin-right:38px">
                            <input class="isInputText" name="I-Contact-3-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Contact-3-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                    <th>
                        <div style="margin-right:38px">
                            <input class="isInputText" name="I-Contact-4-1" value="<?php echo htmlentities(stripslashes(ia3_helpers::get_option('Contact-4-1', __('Section Title', 'ia3'))), ENT_NOQUOTES, 'UTF-8'); ?>" />
                        </div>
                    </th>
                </tr>
                <tr>
