    ...
    <body class="archives">
        <div id="screen">
            ...
            <section class="G4 GR" id="content">
                <header>
                    <h1><?php printf(__('Search Results for &lsquo;%s&rsquo;', 'ia3'), get_search_query()); ?></h1>
                    <?php get_search_form(); ?>
                </header>
                <?php if (have_posts()): ?>
                ...
                <?php else: ?>
                <p><?php printf(__('Your search for <em>%s</em> returned no results.', 'ia3'), get_search_query()); ?></p>
                <?php endif; ?>
