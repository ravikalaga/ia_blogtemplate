<header>
    <h1 class="G2 GS">
       <a class="G1 GS" href="http://ravikalaga.com/blog"><img alt="iA" src="<?php echo ia3_helpers::get_option('Logo', 'http://ravikalaga.com/wp-content/uploads/2011/06/header_straightsmall_v2.png'); ?>" /></a>
    </h1><!-- .G2.GS -->
    <!--<nav>
