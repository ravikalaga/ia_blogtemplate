<style type="text/css">
    ...
    .isColInput p.chck input{
    position: absolute; top:3px;
    }
    
    .isColInput p.chck em{ 
    margin-left: 20px;
    }
    ...
    #isIa3Back table.Twooser td,
    #isIa3Back table.Twooser th {
    border-bottom:none;
    padding-bottom:0;
    }
    
    #isIa3Back table.Twooser tr.lastChild td,
    #isIa3Back table.Twooser tr.lastChild th {
    border-bottom:dotted 1px #CCC;
    padding-bottom:23px;
    }
    
    #isIa3Back table.Twooser.lastChild tr.lastChild td,
    #isIa3Back table.Twooser.lastChild tr.lastChild th {
    border-bottom:none;
    }
...
<div class="wrap">
    ...
    <div id="isIa3Back">
        <?php preg_match("/([1-5]{1})/", $_GET['tab'])? @include('admin_tab_' . (int) $_GET['tab'] . '.php'): @include('admin_tab_1.php'); ?>
    </div><!-- #isIa3Back -->
</div>